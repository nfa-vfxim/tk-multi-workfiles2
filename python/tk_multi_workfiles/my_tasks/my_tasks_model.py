...
class MyTasksModel(ShotgunExtendedEntityModel, ViewItemRolesMixin):
    ...
    def __init__(
        ...
        self.role_methods = {
            self.VIEW_ITEM_THUMBNAIL_ROLE: view_item_config_hook.get_task_item_thumbnail,
            self.VIEW_ITEM_HEADER_ROLE: view_item_config_hook.get_task_item_title,
            self.VIEW_ITEM_SUBTITLE_ROLE: view_item_config_hook.get_task_item_subtitle,
            self.VIEW_ITEM_TEXT_ROLE: view_item_config_hook.get_task_item_details,
            self.VIEW_ITEM_ICON_ROLE: view_item_config_hook.get_task_item_icons,
            self.VIEW_ITEM_WIDTH_ROLE: view_item_config_hook.get_task_item_width,
            self.VIEW_ITEM_SEPARATOR_ROLE: view_item_config_hook.get_task_item_separator,
        }
