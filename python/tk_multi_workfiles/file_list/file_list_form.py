...
class FileListForm(QtGui.QWidget):
    ...
    def __init__(
        ...
        thumbnail_icon = QtGui.QIcon(":/tk-multi-workfiles2/mode_switch_thumb.png")
        thumbnail_icon.addPixmap(
            QtGui.QPixmap(":/tk-multi-workfiles2/mode_switch_thumb_active.png"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.On,
        )
        self._ui.thumbnail_mode.setIcon(thumbnail_icon)

        list_icon = QtGui.QIcon(":/tk-multi-workfiles2/mode_switch_card.png")
        list_icon.addPixmap(
    ...
    def selected_file(self):
        ...
        if selection_model:
            ...
            if len(selected_indexes) == 1:
                selected_file = selected_indexes[0].data(FileModel.FILE_ITEM_ROLE)
                env_details = selected_indexes[0].data(FileModel.WORK_AREA_ROLE)
        ...
        try:
            ...
            if id(selected_item) != id(prev_selected_item):
                ...
                if selected_item:
                    ...
                    selected_file = selected_item.data(FileModel.FILE_ITEM_ROLE)
                    env_details = selected_item.data(FileModel.WORK_AREA_ROLE)
    ...
    def _on_selection_changed(self, selected, deselected):
        ...
        if item:
            # extract the file item from the index:
            selected_file = item.data(FileModel.FILE_ITEM_ROLE)
            env_details = item.data(FileModel.WORK_AREA_ROLE)
